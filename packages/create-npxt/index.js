...
const { yellow, blue, red, green } = require('kolorist');
...
async function init() {
  ...
  const defaultProjectName = !targetDir ? "npxt-project" : targetDir;
  ...
  const templateDir = path.join(__dirname, template.replace('npxt', 'template'));
